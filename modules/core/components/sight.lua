...
function Sight:setCellExplored(x, y, explored) self.explored:set(x, y, explored) end

function Sight:getFOVCell(x, y) return self.fov:get(x, y) end

function Sight:setFOVCell(x, y, value) self.fov:set(x, y, value) end

function Sight:getRawFOVCell(x, y) return self.raw_fov:get(x, y) end

function Sight:setRawFOVCell(x, y, value) self.raw_fov:set(x, y, value) end
