...
SentientWeapon:afterAction(actions.Attack, function(self, level, actor, action)
<<<<<<< HEAD
...
=======
	...
	if faction_component:has("arachnid") and action.hit and defender_died then
		local speak_effect =
			effects.SpeakEffect(actor, onkill_messages[math.random(1, #onkill_messages)], { 0.0, 1.0, 0.0, 1.0 })
