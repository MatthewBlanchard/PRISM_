...
function Color.multiplyScalar(color, s) return { color[1] * s, color[2] * s, color[3] * s } end
...
<<<<<<< HEAD
   return ("rgb(%d,%d,%d)"):format(
      Color._clamp(color[1]),
      Color._clamp(color[2]),
      Color._clamp(color[3])
   )
=======
	return ("rgb(%d,%d,%d)"):format(Color._clamp(color[1]), Color._clamp(color[2]), Color._clamp(color[3]))
>>>>>>> fbe4a4adf3bf1fc96ecb985cb65c5a009faf5ebc
end
...
function Color._clamp(n) return n < 0 and 0 or n > 255 and 255 or n end

function Color.__add(a, b) return add({}, a, b) end
function Color.__mul(a, b) return mul({}, a, b) end
=======
	return ("#%02x%02x%02x"):format(Color._clamp(color[1]), Color._clamp(color[2]), Color._clamp(color[3]))
end
