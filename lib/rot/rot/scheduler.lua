...
<<<<<<< HEAD
function Scheduler:getTime() return self._queue:getTime() end
=======
...
=======
	if repeating then
		table.insert(self._repeat, item)
	end
	return self
>>>>>>> fbe4a4adf3bf1fc96ecb985cb65c5a009faf5ebc
end
...
-- @treturn number time
<<<<<<< HEAD
function Scheduler:getTimeOf(item) return self._queue:getEventTime(item) end
=======
