...
function TextDisplay:getCharHeight()
	return self._charHeight
end
function TextDisplay:getCharWidth()
	return self._charWidth
end
function TextDisplay:getWidth()
	return self:getWidthInChars()
end
function TextDisplay:getHeight()
	return self:getHeightInChars()
end
function TextDisplay:getHeightInChars()
	return self._heightInChars
end
function TextDisplay:getWidthInChars()
	return self._widthInChars
end
function TextDisplay:getDefaultBackgroundColor()
	return self.defaultBackgroundColor
end
function TextDisplay:getDefaultForegroundColor()
...
=======
function TextDisplay:getBackgroundColor(x, y)
	return self._backgroundColors[x][y]
end
>>>>>>> fbe4a4adf3bf1fc96ecb985cb65c5a009faf5ebc
...
=======
function TextDisplay:getForegroundColor(x, y)
	return self._foregroundColors[x][y]
end
>>>>>>> fbe4a4adf3bf1fc96ecb985cb65c5a009faf5ebc
...
<<<<<<< HEAD
function TextDisplay:clearCanvas() self._canvas:clear() end
=======
